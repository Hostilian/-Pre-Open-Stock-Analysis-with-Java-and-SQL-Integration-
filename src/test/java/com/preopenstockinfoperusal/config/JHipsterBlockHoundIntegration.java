package com.preopenstockinfoperusal.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.preopenstockinfoperusal.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.preopenstockinfoperusal.security.DomainUserDetailsService", "createSpringSecurityUser");
